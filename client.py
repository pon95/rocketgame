...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, pos):
        ...
        self.image = pygame.transform.scale(pygame.image.load("rocket.png"), (40, 60))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        # Загружаем спрайт игрока
        self.image = pygame.transform.scale(pygame.image.load("ufo.png"), (80, 40))
        self.rect = self.image.get_rect(center=pos)
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, pos):
        ...
        # Загружаем спрайт игрока
        self.image = pygame.transform.scale(pygame.image.load("bullet.png"), (20, 60))
        self.rect = self.image.get_rect(center=pos)